...
" Rust highlighting
call <sid>hi("rustCharacterInvalid",               s:gui0A, "", s:gui0A, "", "", "")
call <sid>hi("rustCharacterInvalidUnicode",               s:gui0A, "", s:gui0A, "", "", "")
call <sid>hi("rustCommentBlockDoc",               s:gui0A, "", s:gui0A, "", "", "")
call <sid>hi("rustCommentBlockDocError",               s:gui0A, "", s:gui0A, "", "", "")
call <sid>hi("rustCommentLineDoc",               s:gui0A, "", s:gui0A, "", "", "")
call <sid>hi("rustCommentLineDocError",               s:gui0A, "", s:gui0A, "", "", "")
call <sid>hi("rustConstant",               s:gui09, "", s:cterm09, "", "", "")
call <sid>hi("rustEscapeError",               s:gui0A, "", s:gui0A, "", "", "")
call <sid>hi("rustFuncName",               s:gui0A, "", s:gui0A, "", "bold", "")
call <sid>hi("rustIdentifier",               s:gui0A, "", s:gui0A, "", "", "")
call <sid>hi("rustInvalidBareKeyword",               s:gui0A, "", s:gui0A, "", "", "")
call <sid>hi("rustKeyword",               s:gui08, "", s:cterm08, "", "", "")
call <sid>hi("rustLifetime",               s:gui0A, "", s:gui0A, "", "", "")
call <sid>hi("rustMacro",               s:gui0A, "", s:gui0A, "", "", "")
call <sid>hi("rustMacroVariable",               s:gui0A, "", s:gui0A, "", "", "")
call <sid>hi("rustModPath",               s:gui0A, "", s:gui0A, "", "", "")
